...
console.log(dayFour[1](["aa bb cc dd ee"]) === 1);
console.log(dayFour[1](["aa bb cc dd aa"]) === 1);
console.log(dayFour[1](["aa bb cc dd aaa"]) === 1);

console.log("\tDay 4-1 answer:");
console.log(dayFour[1](day4Input));

console.log("\tDay 4-2 test data:");
console.log(dayFour[2](["abcde fghij"]) === 1);
console.log(dayFour[2](["abcde xyz ecdab"]) === 1);
console.log(dayFour[2](["a ab abc abd abf abj"]) === 1);
console.log(dayFour[2](["iiii oiii ooii oooi oooo"]) === 1);
console.log(dayFour[2](["oiii ioii iioi iiio"]) === 1);

console.log("\tDay 4-2 answer:");
console.log(dayFour[2](day4Input));