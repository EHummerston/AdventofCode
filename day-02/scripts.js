const dayTwo = {
    ...
    2: (input) => {
        ...
        for (let i = 0; i < input.length; i++) {
            ...
            for (let j = 0; i < input[i].length && !(high && low); j++) {
                for (let k = 0; k < input[i].length; k++) {

                    if (input[i][j] % input[i][k] === 0 && j !== k) {
                        high = input[i][j];
                        low = input[i][k];
                        break;
                    }
...
/*$('.solve').click(function () {
    ...
    if (!button.prop('disabled')) {
        ...
        code.text(dayTwo[solutionPart](code.text()));
...
console.log("Day 2-1 test data:");
console.log("\t", dayTwo[1]([
    [5, 1, 9, 5],
    [7, 5, 3],
    [2, 4, 6, 8]
]));

console.log("Day 2-1 solution:");
console.log("\t", dayTwo[1](day2Input));

console.log("Day 2-2 test data:");
...
console.log("\t", dayTwo[2](day2Input));